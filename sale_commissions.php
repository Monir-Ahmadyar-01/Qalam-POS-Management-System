    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش کمیشن های فروش </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش کمیشن های فروش</pack>
                </div> 
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="sales_commissions_reciepts.php" class="btn btn-primary btn-sm">ثبت رسید</a>
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <thead>
                                    <?php 
                                        $sql_query_002 = mysqli_query($connection,"SELECT SUM(commissions.amount) as total_purchased_commission FROM commissions WHERE commissions.purchase_commission = 2");

                                        $fetch_002 = mysqli_fetch_assoc($sql_query_002);

                                        $sql_query_003 = mysqli_query($connection,"SELECT SUM(reciepts.amount / reciepts.rate) as total_purchased_commission_reciept FROM reciepts WHERE reciepts.purchase_commission = 2");

                                        $fetch_003 = mysqli_fetch_assoc($sql_query_003);
                                    ?>
                                    <tr class="bg bg-primary text text-white">
                                    <td class="lang" key="Total_Commissions"></td>
                                        <td><?php echo $fetch_002["total_purchased_commission"]; ?></td>
                                        <td class="lang" key="Total_Receipts"></td>
                                        <td><?php echo $fetch_003["total_purchased_commission_reciept"]; ?></td>
                                        <td class="lang" key="Total_Remain"></td>
                                        <td><?php echo $fetch_002["total_purchased_commission"] - $fetch_003["total_purchased_commission_reciept"]; ?></td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `commissions` where purchase_commission = 2");
