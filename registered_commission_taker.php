                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش گیرنده های کمیشن خرید </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش گیرنده های کمیشن خرید </pack>
                </div> 
                <!-- end page title -->
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="register_commission_taker.php?edit_id=<?php echo $row['id']; ?>">
