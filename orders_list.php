    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش درخواست ها </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش درخواست ها </pack>
                </div> 
                <!-- end page title -->
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>تاریخ تسلیمی</th>
                                        <th>وضعیت</th>
                                        <th class="admin_authority">عملیات</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT orders.*,currencies.name as currency_name FROM `orders`  LEFT JOIN currencies ON currencies.id = orders.currency_id order by orders.id desc");
                                        ...
                                        <tr>
                                            ...
                                            if($row["status"] == 0)
                                            {
                                                echo "<span class='text text-danger'>زیر کار</span>";
                                            }
                                            else if($row["status"] == 1)
                                            {
                                                echo "<span class='text text-primary'>تکمیل شده</span>";
                                            }
                                            else
                                            {
                                                echo "<span class='text text-success'>تسلیم شده</span>";
                                            }
                                            ?></td>
                                            ...
                                            <td class="admin_authority">
                                                ...
                                                <a href="order.php?edit_id=<?php echo $row['id']; ?>">
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("orders_list.php",'_self');            
