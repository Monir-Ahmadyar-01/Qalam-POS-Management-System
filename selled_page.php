                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            <div id="accordion">
                                ...
                                if(isset($_POST["search_button"]))
                                {
                                    ...
                                    $sql_query_001 = mysqli_query($connection,"select `qalam_mis`.`sale_major`.`id` AS `bill_number`,`qalam_mis`.`customers`.`full_name` AS `customer_name`,`qalam_mis`.`currencies`.`name` AS `currency_name`,`qalam_mis`.`sale_major`.`date` AS `sale_date`,`qalam_mis`.`sale_major`.`reciept` AS `total_reciept`,(select sum(`qalam_mis`.`sale_minor`.`sale_rate` * `qalam_mis`.`sale_minor`.`amount`) from `qalam_mis`.`sale_minor` where `qalam_mis`.`sale_minor`.`sale_major_id` = `qalam_mis`.`sale_major`.`id`) AS `total_sold_price`,(select sum(`qalam_mis`.`sale_minor`.`expense` * `qalam_mis`.`sale_minor`.`amount`) from `qalam_mis`.`sale_minor` where `qalam_mis`.`sale_minor`.`sale_major_id` = `qalam_mis`.`sale_major`.`id`) AS `total_expense_price`,(select sum(`qalam_mis`.`reciepts`.`amount` / `qalam_mis`.`reciepts`.`rate`) from `qalam_mis`.`reciepts` where `qalam_mis`.`reciepts`.`sale_id` = `qalam_mis`.`sale_major`.`id`) AS `total_reciepts_price` from ((`qalam_mis`.`sale_major` left join `qalam_mis`.`currencies` on(`qalam_mis`.`currencies`.`id` = `qalam_mis`.`sale_major`.`currency_id`)) left join `qalam_mis`.`customers` on(`qalam_mis`.`customers`.`id` = `qalam_mis`.`sale_major`.`customer_id`)) where qalam_mis.sale_major.alterant_id IS NULL and (customers.full_name='$search_input' or sale_major.id like '$search_input' or sale_major.date like '$search_input')  order by `qalam_mis`.`sale_major`.`id` desc");
                                }
                                else
                                {
                                    $sql_query_001 = mysqli_query($connection,"select `qalam_mis`.`sale_major`.`id` AS `bill_number`,`qalam_mis`.`customers`.`full_name` AS `customer_name`,`qalam_mis`.`currencies`.`name` AS `currency_name`,`qalam_mis`.`sale_major`.`date` AS `sale_date`,`qalam_mis`.`sale_major`.`reciept` AS `total_reciept`,(select sum(`qalam_mis`.`sale_minor`.`sale_rate` * `qalam_mis`.`sale_minor`.`amount`) from `qalam_mis`.`sale_minor` where `qalam_mis`.`sale_minor`.`sale_major_id` = `qalam_mis`.`sale_major`.`id`) AS `total_sold_price`,(select sum(`qalam_mis`.`sale_minor`.`expense` * `qalam_mis`.`sale_minor`.`amount`) from `qalam_mis`.`sale_minor` where `qalam_mis`.`sale_minor`.`sale_major_id` = `qalam_mis`.`sale_major`.`id`) AS `total_expense_price`,(select sum(`qalam_mis`.`reciepts`.`amount` / `qalam_mis`.`reciepts`.`rate`) from `qalam_mis`.`reciepts` where `qalam_mis`.`reciepts`.`sale_id` = `qalam_mis`.`sale_major`.`id`) AS `total_reciepts_price` from ((`qalam_mis`.`sale_major` left join `qalam_mis`.`currencies` on(`qalam_mis`.`currencies`.`id` = `qalam_mis`.`sale_major`.`currency_id`)) left join `qalam_mis`.`customers` on(`qalam_mis`.`customers`.`id` = `qalam_mis`.`sale_major`.`customer_id`)) where qalam_mis.sale_major.alterant_id IS NULL  order by `qalam_mis`.`sale_major`.`id` desc");
                                }
         ...
         <!-- | <a href="sales_reciepts.php?sale_id=<?php echo $row['bill_number']; ?>"><span class="fa fa-plus text text-success" ></span></a> -->
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $count_2 = 1;
                                                                $sql_query_004 = mysqli_query($connection,"select (select (select `qalam_mis`.`stock_minor`.`item_name` from `qalam_mis`.`stock_minor` where `qalam_mis`.`stock_minor`.`id` = `qalam_mis`.`stock_major`.`item_id`) from `qalam_mis`.`stock_major` where `qalam_mis`.`stock_major`.`id` = `qalam_mis`.`purchase_minor`.`item_id_stock_major`) AS `item_name`,(select `qalam_mis`.`purchase_major`.`party_number` from `qalam_mis`.`purchase_major` where `qalam_mis`.`purchase_major`.`id` = `qalam_mis`.`purchase_minor`.`purchase_major_id`) AS `party_number`,(select `qalam_mis`.`unit_minor`.`unit_name` from `qalam_mis`.`unit_minor` where `qalam_mis`.`unit_minor`.`id` = (select `qalam_mis`.`stock_major`.`minor_unit_id` from `qalam_mis`.`stock_major` where `qalam_mis`.`stock_major`.`id` = `qalam_mis`.`purchase_minor`.`item_id_stock_major`)) AS `unit_name`,`qalam_mis`.`purchase_minor`.`purchase_price` + `qalam_mis`.`purchase_minor`.`commision_expense` + `qalam_mis`.`purchase_minor`.`office_expense` AS `purchase_price_t`,`qalam_mis`.`sale_minor`.`id` AS `id`,`qalam_mis`.`sale_minor`.`sale_major_id` AS `sale_major_id`,`qalam_mis`.`sale_minor`.`amount` AS `amount`,`qalam_mis`.`sale_minor`.`details` AS `details`,`qalam_mis`.`sale_minor`.`sale_rate` AS `sale_rate` ,`qalam_mis`.`sale_minor`.`expense` AS `expense` from (`qalam_mis`.`sale_minor` left join `qalam_mis`.`purchase_minor` on(`qalam_mis`.`sale_minor`.`purchase_minor_id` = `qalam_mis`.`purchase_minor`.`id`))  where sale_major_id='$parent_id'");
                            ...
                            <tfoot>
                                <tr class="bg bg-primary text text-white">
                                    <th colspan="2"><span class="lang" key="Total Quantity"></span> : <?php echo round($total_weights,2); ?></th>
