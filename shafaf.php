    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="page-title-box print-display">
                ...
                <p class="page-title">صفحه ثبت  رسید های شفاف</pack>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        {
                            $row_id = $_GET["edit_id"];
                            $sql_query_01 = mysqli_query($connection,"SELECT * FROM `shafaf` where id='$row_id'");
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="shafaf_full_name" class="col-form-label">نام مکمل</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark"
                                        name="shafaf_full_name" value="<?php echo $fetch_01["full_name"]; ?>"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="shafaf_full_name"
                                        placeholder="بنویسید .. ">
                                        <input type="hidden" name="edit_id" value="<?php echo $fetch_01["id"]; ?>">
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="number" step="0.01" class="form-control border border-dark" data-toggle="input-mask"
                                        ...
                                        oninput="this.setCustomValidity('')" required value="<?php echo $fetch_01["amount"]; ?>" id="amount" placeholder="بنویسید .. " maxlength="10">
                                </div>
                                <div class="col-md-1 form-group print-display">
                                ...
                                <div class="col-md-1 form-group print-display">
                                        <label for="type"  class="col-form-label">نوعیت</label>
                                        <select id="type" name="type" class="select2 border border-dark form-control">
                                            <?php
                                                $sql_query_01 = mysqli_query($connection,"select * from shafaf_transaction_type");
                                                while ($row = mysqli_fetch_assoc($sql_query_01))
                                                {
                                                    if($row['id'] == $fetch_01["type"])
                                                    {
                                                ?>
                                                <option selected value="<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></option>
                                                <?php
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="date" class="form-control border border-dark" data-toggle="input-mask"
                                        name="date" value="<?php echo $fetch_01["date"]; ?>" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                ...
                                <div class="form-group col-md-2">
                                   ...
                                   <textarea name="details" id="details" class="form-control"><?php echo $fetch_01["details"]; ?></textarea>
                                </div>
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="date" class="form-control border border-dark" data-toggle="input-mask"
                                        name="date" value="<?php echo date("Y-m-d"); ?>" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="date" placeholder="بنویسید .. " maxlength="10">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="details" class="col-form-label">توضیحات</label>
