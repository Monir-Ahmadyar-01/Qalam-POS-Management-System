                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="sales_reciept_full_name" class="col-form-label">نام مکمل</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark"
                                        name="sales_reciept_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="sales_reciept_full_name"
                                        placeholder="بنویسید .. ">
                                    <input type="hidden" name="sale_reciept_id" value="<?php echo $_GET["sale_id"]; ?>">
                                </div>
                                <div class="form-group col-md-2">
