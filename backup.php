...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'qalam_mis');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", "C:\Users\Monir Ahmadyar\Desktop\backup"); // Comment this line to use same script's directory ('.')
...
$backupDatabase = new Backup_Database("localhost", "root", "", "qalam_mis","utf8");
