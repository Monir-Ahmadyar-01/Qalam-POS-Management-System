    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="page-title-box print-display">
                ...
                <p class="page-title">صفحه نمایش حساب مشتری </pack>
            </div>
            <!-- end page title -->
            <?php
            $supplier_id = $_GET["customer_id"];
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php 
                    if(isset($_GET["customer_account_id"]))
                    {
                        $account_id = $_GET["customer_account_id"];
                        $sql_query_01 = mysqli_query($connection,"SELECT * FROM `customer_billance` where id='$account_id'");
                    ...
                    <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label for="customer_reciept_details" class="col-form-label">توضیحات</label>
                                <span class="text-danger">*</span>
                                <textarea name="customer_reciept_details" id="customer_reciept_details" required class="form-control"><?php echo $fetch_01["description"]; ?></textarea>
                                <input type="hidden" name="customer_id_reciept" value="<?php echo $_GET["customer_id"]; ?>">
                                <input type="hidden" name="edit_id" value="<?php echo $_GET["customer_account_id"]; ?>">
                    ...
                    <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label for="customer_reciept_details" class="col-form-label">توضیحات</label>
                                <span class="text-danger">*</span>
                                <textarea name="customer_reciept_details" id="customer_reciept_details" required class="form-control"></textarea>
                                <input type="hidden" name="customer_id_reciept" value="<?php echo $_GET["customer_id"]; ?>">
