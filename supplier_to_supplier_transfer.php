...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="page-title-box print-display">
                <div class="page-title-right print-display">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> ثبت انتقال</li>
                    </ol>
                </div>
                <p class="page-title">انتقال پول بین تمویل کننده ها</pack>
            </div>
            <!-- end page title -->
            <?php
            ...
            {
                $recieve_transfer_supplier_id = $_POST["recieve_transfer_supplier_id"];
                $amount = $_POST["amount"];
                $currency = $_POST["currency"];
                $rate = $_POST["rate"];
                $date = $_POST["date"];
                $details = 'انتقال پول : ' . $_POST["details"];

                $sql_query_02 = mysqli_query($connection,"INSERT INTO `supplier_billance` (`id`, `description`, `credit_amount`, `debit_amount`, `date`, `supplier_id`, `purchase_id`, `currency_id`, `rate`, `commission`, `transfer_supplier`) VALUES (NULL, '$details', '0', '$amount', '$date', '$supplier_id', NULL, '$currency', '$rate', '0', '$recieve_transfer_supplier_id')");

                $sql_query_03 = mysqli_query($connection,"INSERT INTO `supplier_billance` (`id`, `description`, `credit_amount`, `debit_amount`, `date`, `supplier_id`, `purchase_id`, `currency_id`, `rate`, `commission`, `transfer_supplier`) VALUES (NULL, '$details', '$amount', '0', '$date', '$recieve_transfer_supplier_id', NULL, '$currency', '$rate', '0', NULL)");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h2 style="text-align: center;">حساب تمویل کننده : <?php echo $_GET["supplier_name"]; ?></h2>
                        <hr>

                        <form method="post" action=""  enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="full_name" class="col-form-label">  تمویل کننده گیرنده</label>
                                    <span class="text-danger">*</span>
                                    <select id="recieve_transfer_supplier_id" name="recieve_transfer_supplier_id" class="select2 form-control">
                                        <?php
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT supplier_billance.*,(SELECT currencies.name FROM currencies WHERE currencies.id = supplier_billance.currency_id) as currency_name,(SELECT suppliers.full_name FROM suppliers WHERE suppliers.id = supplier_billance.transfer_supplier) as supplier_name FROM supplier_billance WHERE supplier_billance.transfer_supplier='$supplier_id' order by supplier_billance.id ASC");
