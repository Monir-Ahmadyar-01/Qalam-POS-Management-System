            ...
            <div class="page-title-box print-display">
                <div class="page-title-right print-display">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> ثبت گیرنده کمیشن</li>
                    </ol>
                </div>
                <p class="page-title">صفحه ثبت گیرنده کمیشن</pack>
            </div>
            <!-- end page title -->
            <?php 
                 ...
                 {
                     $id = $_GET["edit_id"];
                     $sql_query_001 = mysqli_query($connection,"SELECT * FROM `commission_takers` where id='$id'");
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="commission_taker_full_name" class="col-form-label">نام مکمل</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark"
                                        name="commission_taker_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="commission_taker_full_name" value="<?php echo $fetch_001["full_name"]; ?>"
                                        placeholder="بنویسید .. ">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control  border border-dark"
                                        name="commission_taker_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="commission_taker_full_name"
                                        placeholder="بنویسید .. ">
