                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش مصارف دفتر در وقت خرید </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش مصارف دفتر در وقت خرید</pack>
                </div> 
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <thead>
                                    <?php 
                                        $sql_query_002 = mysqli_query($connection,"SELECT SUM(commissions.amount) as total_office_expense FROM commissions WHERE commissions.purchase_office_expense = 1");

                                        $fetch_002 = mysqli_fetch_assoc($sql_query_002);

                                    ?>
                                    <tr class="bg bg-primary text text-white">
                                        <td colspan="3">مجموع مصرف</td>
                                        <td colspan="3"><?php echo $fetch_002["total_office_expense"]; ?></td>
                                    </tr>
                                    <tr>
                                        <th>شماره</th>
                                        <th>مقدار</th>
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `commissions` where purchase_office_expense = '1'");
