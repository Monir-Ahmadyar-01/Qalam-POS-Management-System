                    ...
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <table id="myTable" class="table table-striped table-bordered  nowrap">
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="10" style="font-weight:bolder;">صفحه حساب : <?php echo $_GET["customer_name"]; ?></th>
                                    </tr>
                                    <tr>
                                        <th>شماره</th>
                                        <th>توضیحات</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $total_debit = 0;
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT customer_billance.*,(SELECT currencies.name FROM currencies WHERE currencies.id = customer_billance.currency_id) as currency_name FROM customer_billance WHERE customer_billance.customer_id='$customer_id' order by id ASC");
