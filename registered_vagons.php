                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش   واگون ها </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش واگون ها   </pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `vagons`");
                                        while ($row = mysqli_fetch_assoc($sql_query_001))
                                        {
                                        ?>
                                        <tr>
                                            <td><?php echo $count; ?></td>
                                            <td><?php echo $row["vagon_number"]; ?></td>
                                            <td><?php echo $row["vagon_weight"]; ?></td>
                                            
                                            <td>
                                                <i class="mdi mdi-delete-circle text text-danger" onclick="delete_func(<?php echo $row['id']; ?>)" title="حذف" style="cursor:pointer;"></i> | 
                                                <a href="register_vagon.php?edit_id=<?php echo $row['id']; ?>">
