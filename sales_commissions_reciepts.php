                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control  border border-dark"
                                        name="sale_commission_full_name"
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="number"value='1' step="0.01" class="form-control border border-dark" name="rate" id="rate"  >
                                </div>  
                                <div class="form-group col-md-2">
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT reciepts.id,reciepts.rate,reciepts.full_name,reciepts.amount,reciepts.date,reciepts.details,(SELECT currencies.name FROM currencies WHERE currencies.id = reciepts.currency_id) as currency_name FROM reciepts WHERE reciepts.purchase_commission = 2");
 ...
 <script>
    ...
    <script>
            ...
            if(confirm == true)
            {
                ...
                type: "GET",
                data: {
                sales_commission_reciept_id:id,
                },
                url: "delete.php",
