                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="purchase_reciept_full_name" class="col-form-label">نام مکمل</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark"
                                        name="purchase_reciept_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="purchase_reciept_full_name"
                                        placeholder="بنویسید .. ">
                                        <input type="hidden" name="purchase_reciept_id" value="<?php echo $_GET["purchase_id"]; ?>">
                                </div>
                                <div class="form-group col-md-2">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="number" step="0.01" class="form-control border border-dark" value="1" name="rate" id="rate"  >
                                </div>
                                <div class="form-group col-md-2">
